...
for subdir in subdirs:
    ...
    for graph_file in robot_edge_files:
        ...
        # add line to file
        line = f'--graph_file {robot_path}/{subdir}/edgefiles/{graph_file} --X_file {X_file} --num_samples 1000000 --output {robot_path}/{subdir}/treefiles/ --O_file {O_file} --c_file {c_file}'
