...
for subdir in subdirs:
    ...
    for graph_file in ikea_edge_files:
        ...
        # add line to file
        line = f'--graph_file {circuit_path}/{subdir}/edgefiles/{graph_file} --X_file {X_file} --num_samples 1000000 --output {circuit_path}/stats/'
...
with open('sp_params_3.txt','w') as f:
