...
#SBATCH --array=1-301%10

# Read in parameters file
PARAMS=$(sed -n "${SLURM_ARRAY_TASK_ID}p" /work/ccnr/glover.co/net_design/NetDesign/params/proteins/mcmc_params_2.txt)

#echo "${PARAMS}"
# Run mcmc script with parameters
python /work/ccnr/glover.co/net_design/NetDesign/scripts/run_mcmc.py $PARAMS
